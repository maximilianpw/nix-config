  ...
  outputs = inputs @ {
    ...
    overlays = [
      ...
      (_: prev: let
        ...
        # hunk's executable is wrapped at $out/bin/hunk; sign the actual
        # Mach-O payload instead of the shell wrapper generated by Nix.
        hunk = resignBunBinary llm.hunk "share/hunk/bin/hunk";
