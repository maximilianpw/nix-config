...
# Restore the shared sops identity before the first rebuild (see
# secrets/README.md, "Setting up a New Machine"). It decrypts the CLIProxyAPI
# client token and Home Manager secrets.
