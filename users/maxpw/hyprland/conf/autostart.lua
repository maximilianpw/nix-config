...
hl.on("hyprland.start", function()
	hypr.exec_once({
		...
		"hyprpaper & (for i in $(seq 1 40); do hyprctl hyprpaper wallpaper ',/home/maxpw/nix-config/users/maxpw/wallpapers/futuristic-journey-simon-stalenhag.jpg' && break; sleep 0.5; done)",
		"1password --silent",
		"gammastep",
		"hypridle",
		"swaync",
