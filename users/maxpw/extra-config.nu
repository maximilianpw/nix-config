...
def --wrapped claudex [...args: string] {
  with-env {
    ...
    ANTHROPIC_DEFAULT_OPUS_MODEL: "@CLI_PROXY_MODEL@",
    ANTHROPIC_DEFAULT_SONNET_MODEL: "@CLI_PROXY_MODEL@",
    ANTHROPIC_DEFAULT_HAIKU_MODEL: "@CLI_PROXY_MODEL@",
    CLAUDE_CODE_SUBAGENT_MODEL: "@CLI_PROXY_MODEL@",
    CLAUDE_CODE_ALWAYS_ENABLE_EFFORT: "1",
    CLAUDE_CODE_MAX_TOOL_USE_CONCURRENCY: "3",
    ENABLE_TOOL_SEARCH: "false",
  } { claude --model "@CLI_PROXY_MODEL@" ...$args }
}
...
def --wrapped climi [...args: string] {
  with-env {
    ...
    CLAUDE_CODE_MAX_TOOL_USE_CONCURRENCY: "3",
    ENABLE_TOOL_SEARCH: "false",
  } { claude --model "@CLIMI_MODEL@" --effort max ...$args }
}
