...
update-packages: ## Bump repo-local custom packages (helium, obsidian, coderabbit) via nix-update
	@echo "Bumping custom packages via nix-update..."
	@echo "Note: Linux-only packages (helium, obsidian) cannot be built"
